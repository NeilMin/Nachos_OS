...
public class UserKernel extends ThreadedKernel {
	...
	// size = numPhysPages
	public static LinkedList freePhyPages = new LinkedList<Integer>();

	public static Lock lock;

	public static int remove() {
		return (int)freePhyPages.removeFirst();
	}

	public static void add(int page) {
		freePhyPages.add(page);
	}

	public static int getSize() {
		return freePhyPages.size();
	}

	public static void resetFreePhyPages() {
		freePhyPages.clear();
		int numPhysPages = Machine.processor().getNumPhysPages();
